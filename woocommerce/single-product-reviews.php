...
<div id="reviews" class="woocommerce-Reviews">
	...
	<div class="row">
			...
			<div id="comments">
				...
				<?php if ( have_comments() ) : ?>
					<ol class="commentlist">
						<!-- wp_list_comments- ф-ция, кот получает список комментариев и выводит их -->
						<!-- в callback-функцию можно передать свою ф-цию, где задизайнить вид отдеольного комментария, см документацию -->
		...
		<div class="col-md-6">
			<!-- проверяется: имеет ли право пользователь оставлять отзыв 
			(админка->woocommerce->товары->отзывы могут быть оставлены только проверенными владельцами стоит галочка) -->
